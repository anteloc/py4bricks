...
from py4bricks.dirs import get_user_cache_dir
from py4bricks.download_updates import get_latest_release_id
from py4bricks.generate import generate_parts_lst

logger = logging.getLogger(__name__)

COMPLETE_VERSION = "complete"
LDRAW_URL = "https://library.ldraw.org/library/updates"
cache_ldraw = Path(get_user_cache_dir())
