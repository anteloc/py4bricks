...
from py4bricks.errors import PartError, PartNotFoundError
from py4bricks.lines import (
    MetaCommand,
)
from py4bricks.part import Part
...
class Parts:
    ...
    @classmethod
    def get(cls, parts_lst: str | Path, *args, **kwargs):
    ...
    def _scan_library_directories(self):
        ...
        for item in self.path.parent.iterdir():
            ...
            elif item.name.lower() == "ldconfig.ldr":
