...
from py4bricks.library.parts import Brick1X1
from py4bricks.pieces import *
...
def draw_mandelbrot(x1, z1, x2, z2, r1, i1, r2, i2) -> None:  # noqa: PLR0913
    ...
    while z <= z2:
        ...
        while x <= x2:
            ...
            print(Piece(colour=colour, position=Vector(x * 20, y, z * 20), rotation=Identity(), part=Brick1X1))
            x += 1
