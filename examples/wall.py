...
from py4bricks.library.parts.doors import Door1X4X5LeftWithTransClearGlass
from py4bricks.library.parts.windows import Window1X4X3
...
wall = Wall(length=10, height=8, facing="north", colour=Red, name="front_wall")
...
wall.insert(door, x=6, y=0)

Path("wall.mpd").write_text(repr(wall))
